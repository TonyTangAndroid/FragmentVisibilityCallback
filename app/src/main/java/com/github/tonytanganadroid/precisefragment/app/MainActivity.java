...
//        mViewPager.setOffscreenPageLimit(COUNT - 1);
     ...
     */
    public static class PlaceholderFragment extends SupportPreciseFragment {
        /**
        ...
        public void onFragmentVisible(boolean triggeredByOnResume) {
            Log.d("onFragmentVisible", "section number :" + sectionNumber + ", triggeredByOnResume:" + triggeredByOnResume);
        }

        @DebugLog
        @Override
        public void onFragmentInvisible(boolean triggeredByOnPause) {
            Log.d("onFragmentInvisible", "section number :" + sectionNumber + ", triggeredByOnPause:" + triggeredByOnPause);
        }
    }
